...
$VK = @{
  ...
  'space'=0x20;'back'=0x08;'enter'=0x0D;'esc'=0x1B;'grave'=0xC0;'equals'=0xBB;'plus'=0x6B; 'kpadd'=0x6B; 'kpminus'=0x6D; 'minus'=0xBD;
  'ctrl'=0x11;'shift'=0x10;'alt'=0x12;'up'=0x26;'down'=0x28;'left'=0x25;'right'=0x27;'del'=0x2E;
  'apostrophe'=0xDE;'semicolon'=0xBA;'comma'=0xBC;'period'=0xBE
}
